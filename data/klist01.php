...
$s=$s." and `check` = 1 ORDER BY `id` DESC";
//echo $s;
...
if ( ($mdb['t_pul']!=0) and ($mdb['qarz']==0))
{
	...
	{
	echo "<tr><td align='center'><a href='client01.php?pid=".$mdb['id']."'><b>".$mdb['navbat']."</b></a></td><td><a href='client01.php?pid=".$mdb['id']."'>".$mdb['fio']."</a>$td</td><td><a href='client01.php?pid=".$mdb['id']."'>".$mdb['passport']."</a></td><td><a href='client01.php?pid=".$mdb['id']."'>".$mddb['fio']."</a></td><td><a href='client01.php?pid=".$mdb['id']."'>".$mxdb['xizmat_name']."</a></td><td><a href='client01.php?pid=".$mdb['id']."'>".$mdb['xizmat_type']."</a></td><td><a href='client01.php?pid=".$mdb['id']."'>".convdate($mdb['date'])."</a></td><td><a href='client01.php?pid=".$mdb['id']."'>".$mdb['t_pul']."</a></td><td><a href='client01.php?pid=".$mdb['id']."'>".$mdb['plastik']."</a></td><td><a href='client01.php?pid=".$mdb['id']."'>".$mdb['naqt']."</a></td><td><a href='client01.php?pid=".$mdb['id']."'>".$mdb['qarz']."</a></td> </tr>";
	$pt=$pt+$mdb['t_pul'];
	$pp=$pp+$mdb['plastik'];
	$pn=$pn+$mdb['naqt'];
	$d++;
...
echo "><td align='center'><a href='client01.php?id=".$mdb['id']."'><b>".$mdb['navbat']."</b></a></td><td><a href='client01.php?id=".$mdb['id']."'>".$mdb['fio']."</a>$td</td><td><a href='client01.php?id=".$mdb['id']."'>".$mdb['passport']."</a></td><td><a href='client01.php?id=".$mdb['id']."'>".$mddb['fio']."</a></td><td><a href='client01.php?id=".$mdb['id']."'>".$mxdb['xizmat_name']."</a></td><td><a href='client01.php?id=".$mdb['id']."'>".$mdb['xizmat_type']."</a></td><td><a href='client01.php?id=".$mdb['id']."'>".convdate($mdb['date'])."</a></td><td><a href='client01.php?id=".$mdb['id']."'>".$mdb['t_pul']."</a></td><td><a href='client01.php?id=".$mdb['id']."'>".$mdb['plastik']."</a></td><td><a href='client01.php?id=".$mdb['id']."'>".$mdb['naqt']."</a></td><td><a href='client01.php?id=".$mdb['id']."'>".$mdb['qarz']."</a></td></tr>";
