...
$.extend(true, kendo.ui.Scheduler.prototype.options.messages,{
  ...
  "editor": {
    ...
    "editorTitle": "Событие",
    "end": "Конец",
    "endTimezone": "Конца часовой пояс",
    "repeat": "Повторяться",
    "separateTimezones": "Используйте отдельные начальные и конечные временные зоны",
    "start": "Начало",
    "startTimezone": "Конца часовой пояс",
    "timezone": " ",
    "timezoneEditorButton": "Часовой пояс",
    "timezoneEditorTitle": "Часовые пояса",
    "title": "Название",
    "noTimezone": "Нет часовой пояс"
  },
  "event": "Событие",
  "recurrenceMessages": {
    "deleteRecurring": "Вы хотите, чтобы удалить только это вхождение события или целую серию?",
    "deleteWindowOccurrence": "Удалить текущее вхождение",
    "deleteWindowSeries": "Удалить серии",
    "deleteWindowTitle": "Удалить периодическое элемент",
    "editRecurring": "Вы хотите редактировать только это вхождение события или целую серию?",
    "editWindowOccurrence": "Редактировать текущее",
    "editWindowSeries": "Редактировать серию",
    "editWindowTitle": "Редактировать периодическое элемент"
  },
  "save": "Сохранить",
  "time": "Время",
  "today": "Сегодня",
  ...
  "showWorkDay": "Показать рабочее время"
});
}
